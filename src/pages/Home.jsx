    ...
    <div className="h-full bg-gray-100 flex flex-col justify-between">
      <main className="container mx-auto pt-10">
        <div className="w-full flex flex-col items-center justify-center bg-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 px-8">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h2 className="text-xl font-semibold r mb-4">성격 유형 이해</h2>
              <p className="text-gray-600">
          ...
          <button
            ...
            className=" bg-red-400 text-white py-2 px-6 rounded-full hover:bg-gray-100 transition mb-4 hover:text-red-600"
          >
            내 성격 알아보러 가기
          </button>
        </div>
